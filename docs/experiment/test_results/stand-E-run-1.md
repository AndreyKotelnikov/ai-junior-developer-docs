# Прогон: Конфигурация E, повторение 1

**Дата**: 2026-03-24 08:15
...
| Метрика | Значение |
|---------|----------|
| task_id | afb84044-fb6b-4c33-95f7-ffe613e8da7d |
| Статус | success |
| Pass@1 | 1 |
| Время | 548 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 43d56a3d-bb4b-4294-ae16-e234a749b1ef |
| Статус | success |
| Pass@1 | 1 |
| Время | 459 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | ee698c52-2776-4f13-9c1d-ae96967c2625 |
| Статус | success |
| Pass@1 | 1 |
| Время | 511 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 7a11cdc4-9f39-46bc-9777-5d2eeca73a18 |
| Статус | success |
| Pass@1 | 1 |
| Время | 466 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 004bf01c-2fb3-466f-bc0b-50159e0620d7 |
| Статус | success |
| Pass@1 | 1 |
| Время | 294 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 6b6c9e38-2318-448c-96f0-1ae019bc44e8 |
| Статус | success |
| Pass@1 | 1 |
| Время | 714 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 6d745289-23e7-497a-80aa-df38d029f0fa |
| Статус | success |
| Pass@1 | 1 |
| Время | 722 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | ec4b449d-5edd-4212-8f41-58a2b6110753 |
| Статус | success |
| Pass@1 | 1 |
| Время | 747 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 22283630-5c68-451e-83c9-60d431aceb50 |
| Статус | success |
| Pass@1 | 1 |
| Время | 869 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | 58afb5c1-139b-403b-a31a-8349b89fd8a8 |
| Статус | success |
| Pass@1 | 1 |
| Время | 939 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | e467e72e-ae56-453e-a958-4e3eb6c24957 |
| Статус | success |
| Pass@1 | 1 |
| Время | 882 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | ca097f78-5924-4a97-9579-dd606561f10b |
| Статус | success |
| Pass@1 | 1 |
| Время | 827 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | ac882349-a939-4620-94ef-eb94c5c3b5da |
| Статус | failed |
| Pass@1 | 0 |
| Время | 945 сек |
| Build итераций | 0 |
...
### Анализ
Тест завершился с ошибкой: Build fix loop aborted: errors grew for 3 consecutive attempts (12 -> 12). Fix loop is making things worse.
...
| Метрика | Значение |
|---------|----------|
| task_id | 22817343-9f30-4690-8818-3bcd1905802c |
| Статус | failed |
| Pass@1 | 0 |
| Время | 731 сек |
| Build итераций | 0 |
...
| Метрика | Значение |
|---------|----------|
| task_id | a1ae73e4-426d-4585-95e0-11de3ceaecf0 |
| Статус | success |
| Pass@1 | 1 |
| Время | 732 сек |
| Build итераций | 0 |
...
| Avg time | 692 сек |
| Total time | 10386 сек (173.1 мин) |

### Сводная таблица

| # | Тест | Сложность | Статус | Pass@1 | Completeness | Время |
|---|------|-----------|--------|--------|--------------|-------|
| 1 | Portfolio +2 поля | Простая | success | 1 | 1/1 (100%) | 548 сек |
| 2 | OrganizationPerson +3 поля | Простая | success | 1 | 1/1 (100%) | 459 сек |
| 3 | PhotoReportItem +2 поля | Простая | success | 1 | 1/1 (100%) | 511 сек |
| 4 | SubmittedDocumentsTemplate +2 поля | Простая | success | 1 | 1/1 (100%) | 466 сек |
| 5 | ContractCurrency +1 enum | Простая | success | 1 | 1/1 (100%) | 294 сек |
| 6 | ConstructionSection +5 полей | Средняя | success | 1 | 1/2 (50%) | 714 сек |
| 7 | Experience +4 поля | Средняя | success | 1 | 2/3 (67%) | 722 сек |
| 8 | MediaLink +4 поля | Средняя | success | 1 | 1/3 (33%) | 747 сек |
| 9 | SpecialZone +5 полей | Средняя | success | 1 | 1/3 (33%) | 869 сек |
| 10 | CheckPoint +4 поля | Средняя | success | 1 | 1/3 (33%) | 939 сек |
| 11 | Notice +5 полей | Сложная | success | 1 | 2/3 (67%) | 882 сек |
| 12 | EscrowAccount +5 полей | Сложная | success | 1 | 1/3 (33%) | 827 сек |
| 13 | 10 сущностей +2 поля | Сложная | failed | 0 | 6/10 (60%) | 945 сек |
| 14 | BankPolicy + BankPolicyItem | Сложная | failed | 0 | 0/3 (0%) | 731 сек |
| 15 | SalesData +5 полей | Сложная | success | 1 | 1/3 (33%) | 732 сек |
